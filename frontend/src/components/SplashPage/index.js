...
function SplashPage() {
  ...
  return (
    ...
    <div className="sp-one" id="sp-one">
        <div>
            <div>
            <img style={{ width: "124px", height: "124px"}} src="https://images.ctfassets.net/lmx885sr3per/2eQ8UnJ4tmqGGlbsguT2mU/d4409b8986044f284581859c7a0524df/ScootScoot.svg"></img>
            <h1 style={{ fontSize: "32px", margin: "15px" }} >Become a Dasher</h1>
            <p style={{ fontSize: "18px"}}>As a delivery driver, you'll make reliable money – working anytime, anywhere.</p>
            </div>
            <span id="sp-butt-one" >Start earning<i class="fi fi-rr-arrow-small-right"></i></span>
        </div>
        <div>
            <div>
            <img style={{ width: "124px", height: "124px"}} src="https://images.ctfassets.net/lmx885sr3per/1p9xn0clqts8OZaX6Ychbv/c2305486c74618057824dfdd5cec66ca/Become_a_Partner.svg"></img>
            <h1 style={{ fontSize: "32px", margin: "15px" }} >Become a Partner</h1>
            <p style={{ fontSize: "18px"}}>Grow your business and reach new customers by partnering with us.</p>
            </div>
            <span id="sp-butt-one" >Sign up your store <i class="fi fi-rr-arrow-small-right"></i></span>
        </div>
        <div>
            <img style={{ width: "124px", height: "124px"}} src="https://images.ctfassets.net/lmx885sr3per/kA6ZnIjNlZk5dnkShe54T/104df1b5309df686a21fffa46fd0e1a1/iphone__1_.svg"></img>
            <div>
            <h1 style={{ fontSize: "32px", margin: "15px" }} >Get the best DoorDash experience</h1>
            <p style={{ fontSize: "18px"}}>Experience the best your neighborhood has to offer, all in one app.</p>
            </div>
            <span id="sp-butt-one" >Get the app <i class="fi fi-rr-arrow-small-right"></i></span>
        </div>
    </div>
    <div className="sp-two">
        <div>
            ...
            <button style={{ fontSize: "16px" }} id="sp-butt">Find restaurants</button>
        </div>
    ...
    <div className="sp-three" style={{ backgroundColor: "rgb(254, 241, 238)"}}>
        <img src="https://images.ctfassets.net/lmx885sr3per/44nvThBCxYBS0kQxJ2d3nq/eb991b92f1da32366c3fdadd2da4adae/dashpass_desktop.png"></img>
        <div>
            ...
            <button style={{ fontSize: "16px" }} id="sp-butt">Get DashPass</button>
        </div>
    </div>
    <div className="sp-four">
        ...
        <button  style={{ fontSize: "16px" }} id="sp-butt">Shop Groceries</button>
        </div>
    </div>
    <div className="sp-five">
        <div>
            ...
            <button style={{ fontSize: "16px" }} id="sp-butt">Shop now</button>
        </div>
    ...
    <div className="sp-six">
        <h1>Helping with to-dos and gifting</h1>
        <div>
        <div>
            ...
            <button style={{ marginTop: "5px", marginBottom: "5px", fontSize: "16px"}}  id="sp-butt">Try Package Pickup</button>
        </div>
        <div>
            ...
            <button style={{ marginTop: "5px", marginBottom: "5px",fontSize: "16px"}}  id="sp-butt">Send Flowers</button>
        </div>
        <div>
        <img src="https://images.ctfassets.net/lmx885sr3per/55MCL8IuU99ZE6B3nsqnRr/c87d4069fe93e80daae4e4bfcdc6fcae/alcohol_desktop.png"></img>
            ...
            <button style={{ marginTop: "5px", marginBottom: "5px", fontSize: "16px"}}  id="sp-butt">Shop Alcohol</button>
            <span>*Must be 21+. Enjoy responsibly.</span>
        </div>
        <div>
        <img src="https://images.ctfassets.net/lmx885sr3per/UoD5uO9zHQvNlWoXsVsVG/5b6e260ba029ec05900e9d2d86649195/pet_supplies_desktop.png" ></img>
            ...
            <button style={{ marginTop: "5px", marginBottom: "5px", fontSize: "16px"}} id="sp-butt">Get Pet Supplies</button>
        </div>
        </div>
    </div>
    ...
    <div className="sp-eight">
        <div>
            ...
            <button style={{ fontSize: "16px" }} id="sp-butt">Become a Dasher</button>
        </div>
    ...
    <div className="sp-nine">
        <img src="https://images.ctfassets.net/lmx885sr3per/6O0y75ccXWzyi7O734BTRs/67ff4785cea1c07bc402d55e96126581/work_with_doordash_desktop.png" ></img>
        <div>
            ...
            <button  style={{ fontSize: "16px" }} id="sp-butt">Become a Partner</button>
        </div>
    </div>
    <div className="sp-ten">
        <h1 style={{ margin: "40px"}}>Get more from your neighborhood</h1>
        <div>
        <div id="top-one">
            <span>
                <p>Top Citites</p>
