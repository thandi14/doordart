...
function HomePage({ isLoaded }) {
  ...
  const { location, setProfile, profile } = useFilters()
 ...
 useEffect(() => {
  ...
  return (
    ...
    <span style={{ display: "flex", gap: "10px"}}>
        { <i id="gotobutt-two" style={{ left: "0", width: "100%" }} onClick={goToPrevTwo} class="fi fi-sr-angle-circle-left"></i>}
        { <i id="gotobutt-two" style={{ right: "0", width: "100%" }} onClick={goToNextTwo} class="fi fi-sr-angle-circle-right"></i>}
    </span>
    </div>
    ...
    </div> : <div><h1 style={{ fontSize: "26px"}}>All Stores</h1></div> }
    </div>
